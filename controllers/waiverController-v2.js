...
//Submit form for Pediatric Consent
function submitPediatricConsentform() {
    var dateSigned = document.getElementById("dateSigned").value;
    var dentistSignature = document.getElementById("dentist-signature-input").value;
    var patientName = document.getElementById("patientName").value;
    var patientSignature = document.getElementById("patient-signature-input").value;
    ...
    fd.append('clientId', clientId);
    $.ajax({
        url: "services/addPediatricWaiver.php",
        data: fd,
        processData: false,
        contentType: false,
        type: 'POST',
...
//Submit form for Dental Crowns / Bridges / Onlays / Inlays Consent
function submitDboiConsentform() {
    var dateSigned = document.getElementById("dateSigned").value;
    var dentistSignature = document.getElementById("dentist-signature-input").value;
    var patientName = document.getElementById("patientName").value;
    var patientSignature = document.getElementById("patient-signature-input").value;
    ...
    fd.append('clientId', clientId);
    $.ajax({
        url: "services/addDboiWaiverService.php",
        data: fd,
        processData: false,
        contentType: false,
        type: 'POST',
...
function submitToothExtractionConsentform() {
    ...
    fd.append('clientId', clientId);
    $.ajax({
        url: "services/addToothExtractionWaiver.php",
        data: fd,
        processData: false,
        contentType: false,
        type: 'POST',
